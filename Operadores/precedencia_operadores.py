# 1. Paréntesis (): Los parentesis tienen la mayor precedencia.
# 2. Exponente **: Este operador calcula la potencia de un número.
# 3. Unario +, -: Estos operadores realizan operadores unarias de positivo y negativo
# 4. Multiplicación *, División /, División entera //, Modulo %
